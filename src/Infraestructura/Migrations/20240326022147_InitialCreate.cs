        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PorCada = table.Column<int>(nullable: true),
                    BaseTarifa = table.Column<double>(nullable: true),
                    BasePeso = table.Column<int>(nullable: true),
                    Monto = table.Column<double>(nullable: true),
                    FechaRegistro = table.Column<DateTime>(nullable: true),
                    FechaModificacion = table.Column<DateTime>(nullable: true),
                    Excedente = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImportadorId = table.Column<int>(nullable: true),
