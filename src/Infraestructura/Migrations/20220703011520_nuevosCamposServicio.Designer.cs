...
namespace Infraestructura.Migrations
{
    ...
    [Migration("20220703011520_nuevosCamposServicio")]
    partial class nuevosCamposServicio
    {
            ...
            modelBuilder.Entity("Dominio.Models.RangoCobros", b =>
                {
                    ...
                    b.HasIndex("TipoCobroUnidadesId");
            ...
            modelBuilder.Entity("Dominio.Models.Servicio", b =>
                {
                    ...
                    b.Property<string>("AliasServicio")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Dominio.Models.RangoCobros", b =>
                {
                    ...
                    b.HasOne("Dominio.Models.Catalogo", "TipoCobroUnidades")
                        .WithMany()
                        .HasForeignKey("TipoCobroUnidadesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Dominio.Models.Servicio", b =>
                {
                    ...
                    b.HasOne("Dominio.Models.Catalogo", "SubCategoria")
                        .WithMany()
